...
```sh
php core/scripts/drupal generate-theme new_theme_name --starterkit vartheme_bs5_horizonaid
```
...
[create a new issue](https://www.drupal.org/node/add/project-issue/vartheme_bs5_horizonaid)
