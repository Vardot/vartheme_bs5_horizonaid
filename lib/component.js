/*
 * ComponentType and ComponentInstance are a paired micro-framework: every
 * component that uses one always imports and uses the other, so they are
 * kept in this single file on purpose rather than split across two.
 */
