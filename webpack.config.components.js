...
module.exports = {
  ...
  entry: {
    ...
    'molecules/accordion-container/accordion-container': ['./components/molecules/accordion-container/accordion-container.scss'],
    ...
    'organisms/card-profile/card-profile': ['./components/organisms/card-profile/card-profile.scss'],
    'organisms/card-country/card-country': ['./components/organisms/card-country/card-country.scss'],
    'organisms/map/map': ['./components/organisms/map/map.scss'],
    ...
    'molecules/program-tab/program-tab': ['./components/molecules/program-tab/program-tab.scss'],
    'organisms/programs/programs': ['./components/organisms/programs/programs.scss'],
    'organisms/country-slider/country-slider': ['./components/organisms/country-slider/country-slider.scss'],
    'organisms/impressed-card-slider/impressed-card-slider': ['./components/organisms/impressed-card-slider/impressed-card-slider.scss'],
