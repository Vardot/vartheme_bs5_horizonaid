...
```twig
{% include 'vartheme_bs5_horizonaid:navbar-brand' with {
  text: 'Vartheme',
  path: '/',
  image_path: '/themes/contrib/vartheme_bs5_horizonaid/logo.svg',
  width: 120,
  height: 32,
  alt: 'Vartheme logo',
...
- The component declares library dependencies on `vartheme_bs5_horizonaid/bs-collapse-script` and `vartheme_bs5_horizonaid/bs-dropdown-script`.
