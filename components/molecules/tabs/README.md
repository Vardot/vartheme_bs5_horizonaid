...
```twig
{% include 'vartheme_bs5_horizonaid:tabs' with {
  shape: 'pills',
...
- The component depends on the `vartheme_bs5_horizonaid/bs-tab-script` library (declared via `libraryOverrides`) for tab toggling behavior.
