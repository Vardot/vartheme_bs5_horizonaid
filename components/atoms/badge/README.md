...
```twig
{% include 'vartheme_bs5_horizonaid:badge' with {
  label: 'New',
...
- The icon is rendered through the `vartheme_bs5_horizonaid:icon` component using the `icon` value without its `bi-` prefix.
