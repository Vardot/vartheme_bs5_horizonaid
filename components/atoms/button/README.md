...
- The icon is rendered through the `vartheme_bs5_horizonaid:bootstrap-icon` component; `icon_first: false` reverses the flex order so the icon follows the label.
