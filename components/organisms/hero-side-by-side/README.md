...
- `heading`: main title text, rendered via `vartheme_bs5_horizonaid:heading`
...
- `image`: main image object shown in the second column, rendered via `vartheme_bs5_horizonaid:image`
...
```twig
{% include 'vartheme_bs5_horizonaid:hero-side-by-side' with {
