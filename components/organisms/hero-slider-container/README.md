...
- wrap one or more `vartheme_bs5_horizonaid:hero-slide` components as carousel slides
...
- `slides`: add one or more `vartheme_bs5_horizonaid:hero-slide` components here (unlimited, drag-and-drop reorder)

## Example: basic slider with two slides

```twig
{% embed 'vartheme_bs5_horizonaid:hero-slider-container' with {
  transition: 'slide',
  autoplay: true,
  interval_ms: 5000,
  pause_on_hover: true,
